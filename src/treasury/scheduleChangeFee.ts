import { digestTypedData } from '@frugalwizard/abi2ts-lib';
...
export async function scheduleChangeFee(
  ...
  try {
    ...
    await treasury.callStatic.scheduleChangeFee(version, fee, deadline, sortedSignatures);
    await treasury.sendTransaction.scheduleChangeFee(version, fee, deadline, sortedSignatures);
